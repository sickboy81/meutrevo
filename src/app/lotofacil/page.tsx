...
export default async function LotofacilLanding() {
  const result = await getCachedResult('lotofacil');
  ...
  return (
    <main
      ...
      style={
        {
          '--active-color': '#93098f',
          '--active-glow': 'rgba(147, 9, 143, 0.4)',
            ...
            '@graph': [
              ...
              },
              {
                ...
                mainEntity: [
                  ...
                  {
                    '@type': 'Question',
                    name: 'Qual a proporção ideal de dezenas pares e ímpares na Lotofácil?',
                    acceptedAnswer: {
                      '@type': 'Answer',
                      text: 'Estatisticamente, a combinação mais frequente nos sorteios da Lotofácil é de 8 ímpares e 7 pares (ocorrendo em cerca de 31% dos sorteios) ou 7 ímpares e 8 pares (cerca de 26%). Jogos criados com proporções extremas como 13 pares e 2 ímpares possuem chances extremamente baixas.',
                    },
                  },
                ],
              },
      ...
      <div className="landing-container animate-fade-in">
        ...
        <section className="landing-hero landing-hero-sales">
          <div className="landing-hero-copy">
            <span className="hero-preview-kicker" style={{ color: '#93098f' }}>
              Loterias da Caixa
            </span>
            <h1
            ...
            <div className="landing-proof-row" aria-label="Destaques Lotofácil">
              <span>
                <strong>Média Repetição</strong> 9 dezenas anteriores
              </span>
              <span>
          ...
          <div
            ...
            aria-label="Último concurso Lotofácil"
          >
        ...
        <section style={{ padding: '2rem 0' }}>
          ...
          >
            Na Lotofácil, você marca entre 15 e 20 dezenas, das 25 disponíveis.
            A probabilidade de acertar os 15 números sorteados com um jogo
            simples é de <strong>1 em 3.268.760</strong>. Trata-se de uma das
            loterias mais populares por suas altas taxas de retorno nas faixas
            de premiação menores (11, 12 e 13 acertos).
          </p>
            ...
            <div className="landing-feature-card">
              <div
                ...
                style={{
                  ...
                  borderColor: 'rgba(147, 9, 143, 0.2)',
                  color: '#93098f',
                }}
              >
                🔄
              ...
              <div className="feature-info">
                <h3>Regra da Repetição</h3>
                <p>
                  Em média, 9 dezenas do sorteio anterior se repetem no próximo.
                  O Meu Trevo analisa e sugere automaticamente as melhores
                  dezenas do concurso anterior para você incluir.
                </p>
              </div>
            </div>
            <div className="landing-feature-card">
              ...
              <div className="feature-info">
                ...
                <p>
                  Evite cartões improváveis. Em 70% dos concursos, a soma de
                  todas as 15 dezenas sorteadas fica no intervalo entre 170 e
                  220.
                </p>
              </div>
            </div>
        ...
        <div style={{ margin: '2rem 0' }}>
          <h2 className="landing-section-title">
            <span>⚙️</span> SIMULADOR EXPRESSO DA LOTOFÁCIL
          </h2>
          <QuickSimulator initialResult={result} initialLottery="lotofacil" />
        </div>
        ...
        >
          ...
          >
            Aumente a consistência na Lotofácil
          </h2>
          <p
            style={{
              color: 'var(--text-muted)',
          ...
          >
            Use os filtros automáticos avançados baseados em primos, Fibonacci,
